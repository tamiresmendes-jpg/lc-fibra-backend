...
async function initSchema() {
  ...
  await pool.query(`
    ...
    -- Campos usados na aba Análise da Meta do Comercial
  ...
  // Cache da Análise de Produto (processamento pesado por período) — processa 1x e reusa
  await pool.query(`
    CREATE TABLE IF NOT EXISTS erp_analise_cache (
      id TEXT PRIMARY KEY,
      empresa_id TEXT NOT NULL,
      data_inicio TEXT NOT NULL,
      data_fim TEXT NOT NULL,
  ...
  `);
  await pool.query(`ALTER TABLE chat_grupos ADD COLUMN IF NOT EXISTS emoji TEXT DEFAULT '💬'`);
