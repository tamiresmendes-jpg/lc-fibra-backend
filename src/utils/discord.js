...
const EVENTOS = ['ciencia', 'pop', 'processo', 'aniversario', 'aniversario_empresa', 'dayoff', 'feriado', 'rhid', 'meta', 'meta_fin', 'meta_cc', 'meta_batida', 'meta_cancelamento', 'ranking_mes', 'comunicado', 'coffee', 'mural', 'cultura', 'chatmix'];
...
const EVENTO_COL = {
  ...
  meta_batida: 'ev_meta_batida', meta_cancelamento: 'ev_meta_cancelamento', ranking_mes: 'ev_ranking_mes',
...
async function garantirTabela() {
  ...
  try {
    ...
    try { await run('ALTER TABLE integracao_discord ADD COLUMN IF NOT EXISTS ev_meta_cancelamento INTEGER DEFAULT 1'); } catch {}
